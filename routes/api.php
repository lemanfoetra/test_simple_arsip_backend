...
Route::middleware(['auth:sanctum', 'check.token.expiration'])->group(function () {
    Route::prefix('arsip/folder')->group(function () {
        Route::get('/{parrent}', [ArsipController::class, 'index'])->middleware("api.role:arsip_get_list_folders");
        Route::post('/', [ArsipController::class, 'store'])->middleware("api.role:arsip_post_folder");
        Route::put('/{id}', [ArsipController::class, 'update'])->middleware("api.role:arsip_put_folder");
        Route::delete('/{id}', [ArsipController::class, 'delete'])->middleware("api.role:arsip_delete_folder");
    });

    Route::prefix('arsip/file')->group(function () {
